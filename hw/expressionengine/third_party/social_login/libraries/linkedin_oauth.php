...
class linkedin_oauth
{
    ...
    const USERINFO_URI    = '/v1/people/~:(id,first-name,last-name,location,public-profile-url,picture-url,email-address)';
    ...
    {
        require_once(PATH_THIRD.'social_login/libraries/inc/OAuthSimple.php');
