...
class Color_picker_plus_ft extends EE_Fieldtype {
    ...
    private function _include_css_js()
    {
		...
		{
			ee()->cp->add_to_foot('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker-1.1.6.min.css" />');
			ee()->cp->add_to_foot('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker.css" />');
			...
			ee()->cp->add_to_foot('<script type="text/javascript" src="' . $this->theme_url . 'jpicker-1.1.6.min.js"></script>');
